...
namespace PQuery
{
    public abstract class PhysicsShape : IPhysicsShape<PhysicsParameters, RaycastHit, Collider, Vector3D>
    {
        ...
        public abstract void DrawGizmo(PhysicsParameters parameters, Vector3D center);
    }
}
...
namespace PQuery
{
    public abstract class PhysicsShape : IPhysicsShape<PhysicsParameters, RaycastHit, Collider, Vector3Wrapper>
    {
        ...
        public abstract void DrawGizmo(PhysicsParameters parameters, Vector3Wrapper center);
    }
}